...
// 🔴 BURAYA ÖZ DEPLOY LİNKİNİZİ YAPIŞDIRIN!
...
async function sendRequest(data) {
    if (API_URL === "" || API_URL.includes("BURAYA")) {
        showToast("API Linki səhvdir!", "error");
        return { status: "error" };
    }
    try {
...
document.addEventListener('click', function(e) {
    if (e.target.matches('.fa-search') || e.target.closest('.fa-search') || e.target.innerText.includes("Axtar")) {
